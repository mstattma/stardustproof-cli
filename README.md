...
### Long-video scale test (opt-in)

`tests/test_long_video_scale.py` exercises the sign+verify pipeline
against a multi-minute 1080p clip generated by stream-looping the
committed BBB trailer. It is skipped by default and opts in via
env flag:
